...
def overlay_and_ratio_plot(root_files, output_directory):
    ...
    for quan in range(Nquan):
        ...
        latex.SetTextSize(0.045)
        latex.DrawLatexNDC(0.79, 0.91, "#font[42]{DL channel}")
...
if __name__ == "__main__":
    root_files = ["lhe_production_DL_r1.0_f1.0_m172.5_p320900_plots_linear.root", "lhe_production_DL_r1.0_f2.0_m172.5_p320900_plots_linear.root", "lhe_hdampUP_DL_r1.0_f1.0_m172.5_p320900_plots_linear.root", "lhe_hdampUP_DL_r1.0_f2.0_m172.5_p320900_plots_linear.root", "lhe_hdampDOWN_DL_1__r1.0_f1.0_m172.5_p320900_plots_linear.root",  "lhe_hdampDOWN_DL_r1.0_f2.0_m172.5_p320900_plots_linear.root"]
    output_overlay_directory = "ratio_all_linear_DL"
